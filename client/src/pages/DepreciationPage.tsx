    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Calcul de la dépréciation et valeur résiduelle des matériels</p>
        </div>
        <div className="flex items-center gap-2">
          <label className="text-sm text-gray-600">Durée d'amortissement :</label>
          <select
            value={lifespan}
            ...
            <Card>
              <CardBody>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Matériels suivis</p>
            ...
            <Card>
              <CardBody>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Valeur d'achat totale</p>
            ...
            <Card>
              <CardBody>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Valeur résiduelle</p>
            ...
            <Card>
              <CardBody>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Entièrement amortis</p>
                  ...
                  <tbody className="divide-y">
                    {items.map((item: any) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="py-3 text-gray-600">{item.categoryName}</td>
                        ...
                        <td className="py-3 text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <span className="text-xs text-gray-500 w-12 text-right">{item.depreciationPercent}%</span>
                          </div>
                        </td>
                        <td className="py-3 text-center">
                          {item.isFullyDepreciated ? (
                            <span className="px-2 py-0.5 bg-red-100 text-red-700 text-xs rounded-full">Amorti</span>
                          ) : (
                            <span className="px-2 py-0.5 bg-green-100 text-green-700 text-xs rounded-full">En cours</span>
                          )}
                        </td>
                      </tr>
                    ))}
